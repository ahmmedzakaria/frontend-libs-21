...
/**
 * `SmartDropdownMode: 'api-scroll'` implementation — debounced fetch per
 ...
 * components `SmartDropdownComponent` delegates to based on its `mode()`;
 ...
 * `SmartDropdownComponent` is the sole form-integration point for all three
 * modes.
 */
@Component({
